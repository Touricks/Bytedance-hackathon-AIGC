...
| `apps/server/src/modules/shot/shot.controller.ts` | workspace-scoped alias routes | 说明 `/api/workspaces/:workspaceId/shots/:shotId/*` 是 0530 前端稳定契约，`/api/shots/:shotId/*` 是兼容路径。 |
