...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `prompt-requirements`          | 用户提交的结构化创作要求。参考视频导入由模型推荐三因子，再由后端确定性编译 proposed artifact。                                                                     | 手动提交不调用 text provider；参考视频导入只在推荐因子阶段调用 text provider。approve 时记录 `prompt-requirements` 的 assembly metadata。                                                                                                                                                                                                                                                                                                                                                | `prompt_requirements_artifacts.data`。                                                                                                                                                                     | 作为后续 workspace module 的 current requirement id 和 fingerprint。 |
