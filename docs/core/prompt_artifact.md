...
| 字段                                         | Prompt 链路含义                                                                    |
| -------------------------------------------- | ---------------------------------------------------------------------------------- |
| `status/current_stage/stage_state`           | 一键编排进度；`WAITING` 表示等待候选生成、stable 保存或 final compose 完成后重入。 |
