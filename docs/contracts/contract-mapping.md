...
Depends On: `docs/contracts/openapi.yaml`, `docs/contracts/interface.md`
...
3. Update `docs/contracts/openapi.yaml` and `docs/contracts/interface.md`.
4. Update `docs/data/persistence-boundary.md` or `docs/contracts/state-machine.md` if artifact, status, or database shape changes.
